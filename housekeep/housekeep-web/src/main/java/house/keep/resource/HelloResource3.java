...
//
//		StringBuilder sb = HelloResource3.connectDatabase();
...
//
//		return "<html><body><h2>Hello World!</h2><p>" + sb.toString() + "</p></body></html>";
//	}
//
//	/**
//	 * Oracle に接続する。
//	 */
//	private static StringBuilder connectDatabase() {
...
//
//			// 取得したデータを出力する
//			sb.append("TRUNC_DATE, SUM_O_FOOD");
